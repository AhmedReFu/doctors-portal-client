        ...
        <div>
            ...
            <form onSubmit={handleSubmit(onSubmit)}>
                ...
                <div className="form-control w-full max-w-xs">
                    ...
                    />
                    <label className="label">
                        {errors.image?.type === 'required' && <span image="label-text-alt text-red-500">{errors.image.message}</span>}

                    </label>
                </div>
                <input className='btn w-full max-w-xs my-4 text-white' type="submit" value='Add' />
            </form>
        </div>
    );
};
